...
<?php include($template->getTemplate('_projects')) ?>
    ...
    <div class="about-contact-container">
        <div id="about-me" class="about-contact-item">
            ...
            <div class="typography footer-profile-description-container">
                <p class="footer-profile-description">My name is Martin. I work at <a class="link" href="http://www.acmefg.com/" target="_blank">The Acme Facilities Group</a> as a Web Developer. I spend my days designing and implementing web interfaces. I am very dedicated to my craft with <?php echo $timeExperience ?> years experience.</p>
        ...
        <div id="contact" class="about-contact-item">
